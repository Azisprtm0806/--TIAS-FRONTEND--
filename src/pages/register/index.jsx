				...
				>
					<div className="block w-3/5">
						<div className="block mb-6">
							<h1 className="block text-2xl font-bold text-primary-600">Buat Akun Pribadimu</h1>
							<p className="block text-gray-600 text-sm">
								Daftarkan diri anda menjadi keluarga TIAS dengan mengisi Data Pribadi anda!
							</p>
						</div>
						<div className="block mb-6">
						...
						<div className="block mb-6">
							...
							<input type="text" className="form-input" name="email" onChange={inputHandler} value={form.email} required />
						</div>
						<div className="block mb-6">
