...
export default function RiwayatPekerjaanDetail() {
	...
	const EDIT_OPTION = { url: `${EDIT_URL}/${form.rwyt_pekerjaan_id}`, method: "PATCH" };
				...
				<Card className="mt-4">
					...
					<Card.Body className="space-y-4">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" name="divisi" onChange={inputHandler} value={form.divisi} disabled />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
