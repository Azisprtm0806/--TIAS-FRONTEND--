				...
				<Card className="mt-4">
					...
					<Card.Body className="space-y-4">
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="email" className="flex-1" name="email" onChange={inputHandler} value={form.email} required />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Textarea rows="2" name="alamat" onChange={inputHandler} value={form.alamat} required></Form.Textarea>
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
								Dusun <span className="text-danger-600">*</span>
							</Form.Label>
							<span>:</span>
							<Form.Input type="text" className="flex-1" name="dusun" onChange={inputHandler} value={form.dusun} required />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="number" className="flex-1" name="no_hp" onChange={inputHandler} value={form.no_hp} required />
						</Form.Group>
					</Card.Body>
				</Card>
