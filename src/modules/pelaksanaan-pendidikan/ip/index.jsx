				...
				<thead>
					<tr>
						<th className="text-sm border-2 border-white bg-gray-200">
							<div className="flex items-center gap-2 cursor-pointer" onClick={() => sortBy("ip_id")}>
								No
						...
						<th className="text-sm border-2 border-white bg-gray-200">
							<div className="flex items-center gap-2 cursor-pointer" onClick={() => sortBy("tahun")}>
								Tahun
					...
					{!loading &&
						...
						data.map((row, index) => (
							<tr key={`row-${index}`}>
								...
								<td className="text-sm border-2 border-white bg-gray-50 max-w-[8rem] truncate mx-auto">{row.ip}</td>
								<td className="text-sm border-2 border-white bg-gray-50 max-w-[8rem] truncate">{row.tahun}</td>
